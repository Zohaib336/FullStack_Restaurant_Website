...
const SearchPage = () => {
    ...
    const { searchedRestaurant, searchRestaurant, setAppliedFilter, appliedFilter } = useRestaurantStore();
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                        <Input
                            type="text"
                            value={searchQuery}
                            placeholder="Discover restaurants and dishes"
                            onChange={(e) => setSearchQuery(e.target.value)}
                        />
                        <Button onClick={() => searchRestaurant(params.text!, searchQuery, appliedFilter)}
                    ...
                    <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            {searchedRestaurant?.data.map((restaurant: Restaurant, idx: number) => (
                                <Card
                                    key={restaurant._id}
    ...
    return (
        <div className="text-center">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
                Sorry, no results found for "{searchText}". <br />
